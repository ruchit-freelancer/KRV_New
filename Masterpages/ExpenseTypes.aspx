<%@ Page Language="C#" MasterPageFile="~/KRV.master" AutoEventWireup="true" CodeFile="ExpenseTypes.aspx.cs"
    Inherits="Masterpages_ExpenseTypes" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphContent" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <telerik:RadGrid PageSize="20" ID="rgSearch" runat="server" AllowFilteringByColumn="True"
            ...
            <MasterTableView DataSourceID="sdsAddEditRecords" DataKeyNames="ExpenseTypeID" CommandItemDisplay="Top">
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="imgUpdate">
                            <table cellpadding="2" cellspacing="2">
                                <tr>
                                    ...
                                    <td align="left" valign="middle">
                                        <asp:TextBox ID="txtExpenseType" runat="server" Text='<%# Bind("ExpenseType") %>' />
                                        <span style="color: Red;"><small>*</small></span>
                                        <asp:RequiredFieldValidator ID="rfvtxtExpenseType" runat="server" ControlToValidate="txtExpenseType"
                                            SetFocusOnError="true" Display="None" ErrorMessage="Enter Expense Type"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="ExpenseType" FilterControlAltText="Filter ExpenseType column"
                        HeaderText="ExpenseType" SortExpression="ExpenseType" UniqueName="ExpenseType"
                        ...
                        <ItemTemplate>
                            <center>
                                <asp:ImageButton ToolTip='<%# ((Eval("IsActive").ToString()=="1")?"Yes":"No") %>'
                                    ID="imgActive" runat="server" CommandArgument='<%# Eval("ExpenseTypeID") %>'
                                ...
                                <asp:HiddenField ID="hfStateID" runat="server" Value='<%# Eval("ExpenseTypeID") %>' />
    ...
    <asp:SqlDataSource ID="sdsAddEditRecords" runat="server" ConnectionString="<%$ ConnectionStrings:dbConnString %>"
        InsertCommand="KRV_AddExpenseTypes" InsertCommandType="StoredProcedure" SelectCommand="KRV_GetExpenseTypes"
        SelectCommandType="StoredProcedure" UpdateCommand="KRV_UpdateExpenseTypes" UpdateCommandType="StoredProcedure"
        CancelSelectOnNullParameter="false" DeleteCommand="KRV_DeleteExpenseTypes" DeleteCommandType="StoredProcedure">
        <UpdateParameters>
        ...
        <DeleteParameters>
            <asp:Parameter DefaultValue="0" Name="ExpenseTypeID" Type="Int32" />
        </DeleteParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsSoftDelete" runat="server" ConnectionString="<%$ ConnectionStrings:dbConnString %>"
        UpdateCommand="KRV_SoftDeleteExpenseTypes" UpdateCommandType="StoredProcedure">
        <UpdateParameters>
            <asp:Parameter Name="ExpenseTypeID" Type="Int32" DefaultValue="0" />
            <asp:Parameter Name="UserName" Type="String" />
        </UpdateParameters>
